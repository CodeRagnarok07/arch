...
const MyComponent = ({ data }) => {
    ...
    return <>
        ...
        <div className="scale-75 sm:scale-150">
            ...
            <div style={{ "--grados": grados + 'deg' }} className={styles.slider}>
                ...
                <div className={"flex w-full justify-between scale-[2] -translate-y-8"}>
                    <div className='py-4 flex justify-center opacity-[0.05] sm:opacity-[0.01] w-full h-full' onClick={() => handleSlider(false)}>
                    ...
                    <div className='py-4 flex justify-center opacity-[0.05] sm:opacity-[0.01] w-full h-full' onClick={() => handleSlider(true)}>
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
