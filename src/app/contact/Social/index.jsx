...
export default function Socials() {
    return <section className={" flex flex-col  bg1 justify-center "}>
        ...
        <header className="header container">
            ...
            <p className="mt-2 font-medium small">Sigueme en mis redes sociales para estar al día con mis últimos proyectos y publicaciones. {/*  de blog*/}
            </p>
        </header>
        ...
        <div className="container flex items-center justify-center w-[100%] xs:w-3/5 sm:w-3/5 ">
            <div className="flex gap-3 flex-wrap justify-center ">
                ...
                {socials.map((v, k) => (
                    <a href={v.link} key={k}>
                        <img src={v.icon} alt={"link to " + v.name} />
                    </a>
                ))}
            </div>
