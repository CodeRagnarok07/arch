...
export default function Politicas() {
    ...
    return <Section title="Políticas de Privacidad">


        <article className="container article border-primary" >
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to archldevio, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either {'"the Company", "We", "Us" or "Our"'} in this Agreement) refers to angeldevio.vercel.app.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to angeldevio.vercel.app, accessible from <a href="https://angeldevio.vercel.app/" rel="external nofollow noopener" target="_blank">https://angeldevio.vercel.app/</a></p>
                </li>
                <li>
            ...
            <div className="flex justify-center">
                <a href="#contact" className="btn  border-secondary p-2 rounded-[8px]">contact</a>
            </div>
