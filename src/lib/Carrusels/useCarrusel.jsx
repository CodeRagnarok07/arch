...
/**
 * Crea la funcionalidad de un carrusel con display flex
 * @param {string} type hace algo
 * @returns {CarruselRef} = urf para ser utilizado en el contenedor de los childrems
 * @returns {arrowControler} urf para ser utilizado en el contenedor de los childrems
 * @returns {Current} urf para ser utilizado en el contenedor de los childrems
 * @returns {dotControlerRef} urf para ser utilizado en el contenedor de los childrems * 
 */
const useCarrusel = ({type}) => {
